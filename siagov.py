...
if "data" not in st.session_state:
    with zipfile.ZipFile('datasets/empenho_original_exercicio_2023_mesinicio_1_mesfim_9.zip') as z:
        try:
            ...
            empenhosOriginal = pd.read_csv('datasets/empenho_original_exercicio_2023_mes_9.csv', sep=';', encoding = 'ISO-8859-1') #empenhosOriginal = empenhosOriginal[empenhosOriginal["CODIGO_UNIDADE_GESTORA"] == setor]
